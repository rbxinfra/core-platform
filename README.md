...
This repository contains core assemblies under the Roblox.Platform domain (i.e. any assembly that only serves one generic purpose outside of a specific domain)
