...
public class FeatureDisabledException : PlatformException
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FeatureDisabledException" /> class with the given error message.
    /// </summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="FeatureDisabledException" /> class with
